...
function gm.event_hook_pre_add(instance, event_type, event_number, guid, name, callback) end
...
function gm.event_hook_post_add(instance, event_type, event_number, guid, name, callback) end
...
function gm.event_hook_pre_has(instance, event_type, event_number, guid, name) end
...
function gm.event_hook_post_has(instance, event_type, event_number, guid, name) end
...
function gm.event_hook_pre_remove(instance, event_type, event_number, guid, name) end
...
---@return boolean # True if the callback was successfully found and removed.
function gm.event_hook_post_remove(instance, event_type, event_number, guid, name) end
